 ...
 * </pre>
 *
 * Protobuf type {@code logging.AppendEntriesRequest}
 */
public final class AppendEntriesRequest extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:logging.AppendEntriesRequest)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return logging.LoggingProto.internal_static_logging_AppendEntriesRequest_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return logging.LoggingProto.internal_static_logging_AppendEntriesRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            logging.AppendEntriesRequest.class, logging.AppendEntriesRequest.Builder.class);
  }
  ...
  @SuppressWarnings("serial")
  private java.util.List<logging.LogEntry> entries_;
  /**
   * <code>repeated .logging.LogEntry entries = 5;</code>
   */
  @java.lang.Override
  public java.util.List<logging.LogEntry> getEntriesList() {
    return entries_;
  }
  /**
   * <code>repeated .logging.LogEntry entries = 5;</code>
   */
  @java.lang.Override
  public java.util.List<? extends logging.LogEntryOrBuilder> 
   ...
   */
  @java.lang.Override
  public logging.LogEntry getEntries(int index) {
   ...
   */
  @java.lang.Override
  public logging.LogEntryOrBuilder getEntriesOrBuilder(
      int index) {
    return entries_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof logging.AppendEntriesRequest)) {
      return super.equals(obj);
    }
    logging.AppendEntriesRequest other = (logging.AppendEntriesRequest) obj;
  ...
  public static logging.AppendEntriesRequest parseFrom(
  ...
  public static logging.AppendEntriesRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static logging.AppendEntriesRequest parseFrom(
  ...
  public static logging.AppendEntriesRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static logging.AppendEntriesRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static logging.AppendEntriesRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(logging.AppendEntriesRequest prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:logging.AppendEntriesRequest)
      logging.AppendEntriesRequestOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return logging.LoggingProto.internal_static_logging_AppendEntriesRequest_descriptor;
    }
    ...
    // Construct using logging.AppendEntriesRequest.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public logging.AppendEntriesRequest getDefaultInstanceForType() {
      return logging.AppendEntriesRequest.getDefaultInstance();
    }

    @java.lang.Override
    public logging.AppendEntriesRequest build() {
      logging.AppendEntriesRequest result = buildPartial();
    ...
    @java.lang.Override
    public logging.AppendEntriesRequest buildPartial() {
      logging.AppendEntriesRequest result = new logging.AppendEntriesRequest(this);
    ...
    private void buildPartialRepeatedFields(logging.AppendEntriesRequest result) {
      if (entriesBuilder_ == null) {
    ...
    private void buildPartial0(logging.AppendEntriesRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof logging.AppendEntriesRequest) {
        return mergeFrom((logging.AppendEntriesRequest)other);
      } else {
    ...
    public Builder mergeFrom(logging.AppendEntriesRequest other) {
      if (other == logging.AppendEntriesRequest.getDefaultInstance()) return this;
      if (other.getTerm() != 0) {
    ...
    private void ensureEntriesIsMutable() {
      if (!((bitField0_ & 0x00000010) != 0)) {
        entries_ = new java.util.ArrayList<logging.LogEntry>(entries_);
        bitField0_ |= 0x00000010;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        logging.LogEntry, logging.LogEntry.Builder, logging.LogEntryOrBuilder> entriesBuilder_;
    ...
    public Builder setEntries(
        int index, logging.LogEntry value) {
      if (entriesBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setEntries(
        int index, logging.LogEntry.Builder builderForValue) {
      if (entriesBuilder_ == null) {
        ensureEntriesIsMutable();
     ...
     * <code>repeated .logging.LogEntry entries = 5;</code>
     */
    public Builder addEntries(logging.LogEntry value) {
      if (entriesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addEntries(
        logging.LogEntry.Builder builderForValue) {
      if (entriesBuilder_ == null) {
        ensureEntriesIsMutable();
    ...
    public Builder addAllEntries(
        java.lang.Iterable<? extends logging.LogEntry> values) {
      if (entriesBuilder_ == null) {
        ensureEntriesIsMutable();
     ...
     * <code>repeated .logging.LogEntry entries = 5;</code>
     */
    public logging.LogEntry.Builder getEntriesBuilder(
        int index) {
     ...
     * <code>repeated .logging.LogEntry entries = 5;</code>
     */
    public logging.LogEntry.Builder addEntriesBuilder() {
      return getEntriesFieldBuilder().addBuilder(
          logging.LogEntry.getDefaultInstance());
    }
    /**
     * <code>repeated .logging.LogEntry entries = 5;</code>
     */
    public logging.LogEntry.Builder addEntriesBuilder(
        int index) {
      return getEntriesFieldBuilder().addBuilder(
          index, logging.LogEntry.getDefaultInstance());
    }
    /**
     * <code>repeated .logging.LogEntry entries = 5;</code>
     */
    public java.util.List<logging.LogEntry.Builder> 
         getEntriesBuilderList() {
      return getEntriesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        logging.LogEntry, logging.LogEntry.Builder, logging.LogEntryOrBuilder> 
    ...
    // @@protoc_insertion_point(builder_scope:logging.AppendEntriesRequest)
  }

  // @@protoc_insertion_point(class_scope:logging.AppendEntriesRequest)
  private static final logging.AppendEntriesRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new logging.AppendEntriesRequest();
  }

  public static logging.AppendEntriesRequest getDefaultInstance() {
